...
public class Journal extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		resultats.add(date);
		resultats.add("F�tards: "+fetardCourant.getFetard().getPseudo()+ " vs. "+nextFetard.getFetard().getPseudo());
		...
		/*String duree = soiree.getGagnant().getFetard().getPseudo() + " a gagn� la partie en ";
