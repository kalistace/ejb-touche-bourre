...
public class GestionSoireeImpl implements GestionSoiree {
	...
	public Soiree creerSoiree(String nomSoiree, String pseudoFetard1) {
		...
		if (soiree != null) {
			return null;// throw exception, peut pas avoir 2 soir�e 'en cours'
						// avec le meme nom
		}
	...
	public Soiree lancerUneTournee(String nomSoiree, String pseudoFetard,
		...
		try {
			...
			throw new Exception("Nombre de bi�res incorrect pour cette tourn�e");
		} catch (DejaToucheException e) {
			throw new Exception("Case d�j� touch�e par une salve ant�rieure");
		}
	...
	public Soiree commencerSoiree(String nomSoiree) throws Exception {
		...
		if (soiree.getEtat() != Etat.EN_COURS) {
			throw new Exception(
					"conditions non remplies pour commencer la soir�e");
		}
		soiree = soireeDao.chargerTournee(soiree);
		return soiree;
	}
